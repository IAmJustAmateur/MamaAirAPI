...
#
# Legacy mobile API contract check. This keeps the pre-category/pre-counts
# task contract so we can verify older app builds still work with the current
# backend while the main test_server_api.py validates the latest contract.
